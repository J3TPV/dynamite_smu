...
import {
  addDays, addMonths, durationToLabel, fromISODate, minutesToLabel, monthYearLabel,
...
interface Props {
  ...
  onAddEvent: (dateISO: string, startMin?: number) => void;
...
const Agenda: React.FC<{
  ...
  const dayEvents = events.filter(e => e.date === dateISO).sort((a, b) => (a.allDay === b.allDay ? a.start - b.start : a.allDay ? -1 : 1));
  return (
